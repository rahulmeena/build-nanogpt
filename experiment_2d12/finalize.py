...
def finalize(archive):
    ...
    runtime.update(per_condition=timings,scientific_scoring_seconds=scientific,
        ...
        retries=0,final_gpu_finished_to_verified_stop_seconds=stop['verified_at']-gpu['time'])
