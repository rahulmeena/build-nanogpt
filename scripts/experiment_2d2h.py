#!/usr/bin/env python3
"""Experiment 2D2H: move recurrent-memory entry from B1 to B2.

The finalized 2D2B checkpoint is the immutable source.  This driver restores
its base optimizer, data loader, RNG, and next-batch state. The B1 gate and
its Adam state are physically dropped; B2 receives one fresh scalar gate.
"""
...
from experiment_2d2h_core import (  # noqa: E402
    BANK_MODES,
    B2_LOCAL_WINDOW,
...
EXPERIMENT = "2D2H"
PROTOCOL = "master_parallel_4gpu_2d2h_v1"
...
FROZEN_2D2C_TAG = "experiment-2d2c-b2-w2-second-mirrored-link-final"
FROZEN_2D2C_COMMIT = "d948d200c3e70a5256c0d6a3d3cfa4c6818e2569"
FROZEN_2D2C_CHECKPOINT_SHA256 = "5f024fa69ab9473414d570b5649f3050c9694706bf4bc4c9f8bf4764b4034ded"
FROZEN_2D2C_REFERENCE = {
    "initial_w2_compression_damage": 1.3484903198741445,
    "final_parallel_gain": 0.000043220880979522036,
    "final_parallel_sequence_gap": 0.000019802669885216062,
    "final_true_incremental_gain": 0.00001448861861552686,
    "final_true_incremental_sequence_gap": 0.000050281635568971694,
    "true_wins_vs_off": 64,
    "true_wins_vs_shuffled": 71,
    "final_tanh_g_rec_b2": -0.018238622695207596,
    "gain_trajectory": {
        "0": 0.0,
        "20": 0.000009905812202948283,
        "48": -0.000013947896059018916,
        "96": 0.0000624980799330821,
        "143": 0.00005743728142970639,
        "191": 0.000043220880979522036,
    },
    "sequence_gap_trajectory": {
        "0": 0.0,
        "20": 0.000044075284222344635,
        "48": -0.000010018017473800711,
        "96": 0.00004936461382376578,
        "143": 0.00007644330253242515,
        "191": 0.000019802669885216062,
    },
    "gate_trajectory": {
        "0": 0.0,
        "20": 0.0013218846870586276,
        "48": -0.0021486254408955574,
        "96": -0.009678013622760773,
        "143": -0.014996225945651531,
        "191": -0.018238622695207596,
    },
    "raw_gate_trajectory": {
        "0": 0.0,
        "20": 0.0013218855019658804,
        "48": -0.0021486287005245686,
        "96": -0.009678315371274948,
        "143": -0.014997350051999092,
        "191": -0.01824064552783966,
    },
    "available_cursor_hashes": {
        "48": {
            "kind": "scientific",
            "next_batch_sha256": "0bd13fbfbc38e32d6735462a7bbc834df30467374ae97394457e6b0a3436f699",
            "next_stream_sha256": "47aec6fcaef009fb8ed54f2f59022c635441578b3dc81552567ef9a12b7ed625",
        },
        "50": {
            "kind": "recovery",
            "next_batch_sha256": "0a151f4d97003226f12d073dca5da65720f1186a5fa2ed9cc9830c1df8430fd6",
            "next_stream_sha256": "19a41fe90538fa10c63bf067066dc02aa5af62f2e916863e56ee1e0aad31439f",
        },
        "96": {
            "kind": "scientific",
            "next_batch_sha256": "313c1cd86d1924914e395df1bddf98fcb9ab351592c014b3b1357ecbbab33c97",
            "next_stream_sha256": "6a870df86881ba3def08dbbe7bbb5554b959780d788d509c578558b52dd19f31",
        },
        "100": {
            "kind": "recovery",
            "next_batch_sha256": "ffb4d3dcd57c58d6e1ffd2ee680154e5c35b6ffd20c6c2c91c1a1988c0999249",
            "next_stream_sha256": "28ea91f6131a87d721e4a62598b3ec1e693f568029e78e36ebab71697e34ed82",
        },
        "143": {
            "kind": "scientific",
            "next_batch_sha256": "d7d84b7c4ac51dfc823b98acfd327616c0f604cb1771eb7b6cbc283290100fc0",
            "next_stream_sha256": "3c1665f94db597eb909e738a97353d1c237c3a7226c6dabb84af721be9d89702",
        },
        "150": {
            "kind": "recovery",
            "next_batch_sha256": "bbc5f195bde0ac72b7fe8151298dc13d1e353b32527be5d7d08d1dfb77037980",
            "next_stream_sha256": "2296e19de8a8641f53f4e6dc0bdaf9a98bec03bb46a0ebb6cbea61ad0ec15a8e",
        },
        "191": {
            "kind": "scientific",
            "next_batch_sha256": "39808d08e7e15e9f160e32ba838fd28839067827095b023d4f475b30df392086",
            "next_stream_sha256": "110e232ab330611a8d23cddc6e914c8a2d912fd8191873ae67488b0d52f48daa",
        },
    },
}
FROZEN_2D2D_REFERENCE = {
    "true_incremental_gain": 4.624556640742128e-06,
    "true_incremental_sequence_gap": -6.591846502423948e-05,
    "true_wins_vs_off": 60,
...
FROZEN_2D2C_MICRO_BATCH = 32
FROZEN_2D2C_ACCUMULATION = 16
...
REQUIRED_ARTIFACTS = (
    ...
    "matched_2d2d_data_audit.json",
    "semantic_diff_audit.json",
    "batch_manifest.json",
    "preflight_audit.json",
    "initial_combined_damage.json",
...
REQUIRED_PLOTS = tuple(f"P{index}_{name}.png" for index, name in enumerate((
    "real_off_validation_ce",
    "b2_w32_recurrent_gain",
    "b2_w32_sequence_gap",
    "w2_vs_w32_gain",
    "b1_gate",
    "b2_w2_vs_w32_gate",
    "b2_recurrent_attention_mass",
    "b2_recurrent_attention_density",
    "b2_local_attention",
    "b11_to_b2_writer_gradient",
    "b2_per_head_mean_lag",
    "parallel_vs_true_incremental_gain",
    "inference_state_memory",
...
def gradient_group_report(model):
    """Report base and sole B2 scalar-gate gradients."""

    base = [
        parameter.grad
        for name, parameter in model.named_parameters()
        if name != "g_rec_b2" and parameter.grad is not None
    ]
...
def require_git(clean: bool = True) -> None:
    ...
    if clean and git_output("status", "--porcelain"):
        raise SystemExit("result-bearing 2D2H worktree must be clean")
...
def require_config() -> dict:
    ...
    checks = {
        ...
        "protocol": config.get("protocol") == "master_parallel_4gpu_2d2h_v1",
        ...
        == B1_LOCAL_WINDOW
        and config["architecture"]["b1"]["recurrent_path_present"] is False
        and config["architecture"]["b1"]["g_rec_b1_present"] is False
        and config["architecture"]["b1"]["b12_raw_ring_present"] is False
        ...
        == B2_MAX_RECURRENT_ENTRIES,
        "parameter_swap": config["architecture"]["removed_parameters_vs_2d2b"] == ["g_rec"]
        and config["architecture"]["added_parameters_vs_2d2b"] == ["g_rec_b2"]
        ...
        "checkpoints": tuple(config["training"]["scientific_checkpoints"])
        == SCIENTIFIC_CHECKPOINTS
        and config["training"]["forced_fresh_process_restart_after_update"] == 96,
        "optimizer_resume": config["optimizer"]["restore_base_state"] is True
        and config["optimizer"]["drop_b1_gate_group_and_state"] is True
        and config["optimizer"]["fresh_b2_gate_state"] is True,
        "attached": config["training"]["recurrent_source_detached"] is False,
        "lane": config["gpu_lane"] == 2 and config["cuda_visible_devices"] == "2"
        and config["ddp"] is False,
    }
    if not all(checks.values()):
        raise SystemExit(f"2D2H preregistration mismatch: {checks}")
    return config
...
def workspace_mount_audit(output_dir, run_root, supplied_identity) -> dict:
    ...
    if output != expected_output:
        raise SystemExit(f"2D2H result directory must be exactly {expected_output}")
    if not str(output).startswith("/workspace/") or not str(run).startswith("/workspace/"):
        raise SystemExit("2D2H results and checkpoints must live under /workspace")
...
def configure_optimizer(model, device_type="cuda", include_new_gate=True):
    """Restore base groups only and add the fresh B2 gate group."""

    base_decay, base_nodecay = [], []
    for name, parameter in model.named_parameters():
        if not parameter.requires_grad or name == "g_rec_b2":
            continue
    ...
    report = {
        ...
        "eps": legacy.ADAM_EPS,
        "fused": fused_available and device_type == "cuda",
        "source_base_optimizer_restored": False,
        "removed_b1_gate_optimizer_state": True,
...
def load_source_bundle(source_checkpoint, device, restore_rng=False):
    ...
    # Reuse exact base parameter objects, but physically drop the source B1 gate
    # group and Adam state before installing the fresh B2 gate.
    model = RecurrentKVGPT(source_model.base).to(device)
    optimizer = source_optimizer
    if source_model.g_rec not in optimizer.state:
        raise SystemExit("source B1 gate optimizer state is unexpectedly absent")
    del optimizer.state[source_model.g_rec]
    ...
    optimizer_report.update(
        {
            "source_base_optimizer_restored": True,
    ...
    checks.update(
        {
            ...
            == SOURCE_PARAMETERS,
            "b1_gate_parameter_absent": "g_rec" not in dict(model.named_parameters()),
            "b1_gate_state_dict_absent": "g_rec" not in model.state_dict(),
            ...
            "source_base_optimizer_state_preserved": len(optimizer.state)
            == len(payload["optimizer"]["state"]) - 1,
            "source_b1_optimizer_state_removed": source_model.g_rec not in optimizer.state,
    ...
    audit = {
        ...
        "source_optimizer": {
            ...
            "base_restored_then_b1_gate_state_physically_removed": True,
        },
...
def parameter_manifest(model, source_payload) -> dict:
    ...
    source_base_keys = [key for key in source_keys if key != "g_rec"]
    target_base_keys = [key for key in model.state_dict() if key != "g_rec_b2"]
    new_rows = [row for row in inventory if row["name"] == "g_rec_b2"]
    report = {
        "2d2b_named_parameter_inventory": source_inventory,
        "2d2h_named_parameter_inventory": inventory,
        "source_base_inventory_preserved": target_base_inventory == source_base_inventory,
        "source_state_dict_inventory": source_state_inventory,
        "source_base_state_dict_keys_preserved": target_base_keys == source_base_keys,
        "2d2b_total_parameters": sum(row["numel"] for row in source_inventory),
        "2d2h_total_parameters": sum(row["numel"] for row in inventory),
        "added_parameters_vs_2d2b": new_rows,
        "removed_parameters_vs_2d2b": ["g_rec"],
    ...
    report["checks"] = {
        "source_base_inventory_preserved": report["source_base_inventory_preserved"],
        "source_base_state_dict_keys_preserved": report["source_base_state_dict_keys_preserved"],
        "source_total": report["2d2b_total_parameters"] == SOURCE_PARAMETERS,
        "target_total": report["2d2h_total_parameters"] == TOTAL_PARAMETERS,
        ...
        "removed_b1_scalar_exact": "g_rec" not in dict(model.named_parameters())
        and "g_rec" not in model.state_dict(),
...
def architecture_manifest() -> dict:
    return {
        ...
        "links": {
            "B12_to_B1": {
                "present": False,
                "gate_parameter_present": False,
                "raw_state_ring_present": False,
                "reason": "physically removed before 2D2H training",
            },
            "B11_to_B2": {
        ...
        "incremental_b12_raw_residual_capacity": 0,
        "parallel_source_tensor_shapes": {"h11": "[B,T,C]"},
        ...
        "forbidden_modules_absent": {
            ...
            "b12_to_b1_recurrence": True,
            "b1_gate": True,
            "b12_raw_state_ring": True,
        },
    }
...
def matched_2d2c_reference_manifest() -> dict:
    return {
        "schema": "exp2d2h_frozen_2d2c_matched_reference_v1",
        ...
        **copy.deepcopy(FROZEN_2D2C_REFERENCE),
        ...
        "sole_scientific_difference": (
            ...
            "2D2H local W32 plus recurrent lags 32..1023"
        ),
    }
...
def frozen_2d2c_optimizer_audit(current_report) -> dict:
    ...
    return {
        ...
        "current_2d2h_optimizer_report": current_report,
        "checks": checks,
        "passed": all(checks.values()),
    }
...
def initialize_matched_data_replay_audit(source_audit, source_stream, scientific_stream):
    return {
        "schema": "exp2d2h_matched_2d2c_data_replay_audit_v1",
        ...
        "unavailable_comparisons": (
            ...
            "is compared in memory without creating extra 2D2H checkpoints."
        ),
...
def record_matched_replay_cursor(
    ...
    audit["checkpoint_cursor_comparisons"][str(update)] = {
        ...
        "observed_2d2h_next_global_batch_sha256": observed_batch,
        "expected_2d2c_next_global_batch_stream_sha256": reference[
            "next_stream_sha256"
        ],
        "observed_2d2h_next_global_batch_stream_sha256": observed_stream,
...
def semantic_diff_audit(model, source_payload) -> dict:
    ...
    del source_wrapper
    unchanged = {
        "b1_local_window": architecture_manifest()["b1_local_window"] == 2,
    ...
    report = {
        ...
        "architecture_changes": [
            ...
            {"field": "B12->B1 recurrence", "old": "present", "new": "physically absent"},
            {"field": "g_rec B1 gate", "old": "trained scalar", "new": "removed"},
        ...
        "source_base_state_dict_keys_preserved": [
            key for key in model.state_dict() if key != "g_rec_b2"
        ]
        == [key for key in source_payload["model"] if key != "g_rec"],
        "passed": all(unchanged.values()),
    }
    report["passed"] = bool(
        report["passed"] and report["source_base_state_dict_keys_preserved"]
    )
    if not report["passed"]:
...
def evaluate_parallel(
    ...
    for batch_index in range(batches):
        ...
        for name in names:
            ...
            del output, tensor
            torch.cuda.empty_cache()
        print(f"2D2H validation batch={batch_index + 1:02d}/{batches}", flush=True)
        del x, y, cpu_x, cpu_y
        torch.cuda.empty_cache()
    ...
    result = {
        ...
        "b1_recurrent_gate_present": False,
        ...
        "control_labels": {
            "new_real": "REAL_W32",
            "b2_recurrence_off": "B2_OFF_W32",
            "b2_shuffled": "B2_SHUFFLED_W32",
...
def attached_writer_gradient_check(model, val_path) -> dict:
    """Verify the actual Pass-1 B11 writer is attached to Pass-2 B2."""
    ...
    report = {
        ...
        "method": "Actual attached Pass-1 B11 post-MLP source tensor.",
    }
    report["passed"] = (
        report["b11_to_b2"]["finite"]
    ...
    model.zero_grad(set_to_none=True)
    del x, y, first, b2_read, grad_h11
    torch.cuda.empty_cache()
    return report
...
def kernel_preflight(model, short_tokens, short_targets) -> dict:
    """2D2H-only geometry, causality, physical-removal and gate checks."""
    ...
    query = torch.arange(length, device=device).view(length, 1)
    source = torch.arange(length, device=device).view(1, length)
    b1_local = model.local_mask(length, device)
    b2_local = model.b2_local_mask(length, device)
    b2_recurrent = model.b2_recurrent_mask(length, length, device)
    expected_b2 = (source <= query - 32) & (source >= query - 1023)
    values = torch.randn(
        short_tokens.size(0), length, model.config.n_embd, device=device
    )
    bank = model.build_recurrent_bank_b2(values)
    key, value = model.project_recurrent_kv_b2(values)
    normalized = model.base.transformer.h[1].ln_1(values)
    _, expected_key, expected_value = model.base.transformer.h[1].attn.c_attn(
        normalized
    ...
    try:
        ...
        for hook in hooks:
            hook.remove()
    with torch.no_grad():
        plain = model.forward_pass(short_tokens, b2_gate_override=0.0)["logits"]
        zero = model.forward_pass(
            short_tokens,
            b2_recurrent_source=values,
            b2_gate_override=0.0,
        )["logits"]
    weights = active["diagnostics"]["b2"]["recurrent_attention_weights"]
    changed = short_tokens.clone()
    changed[:, -1] = (changed[:, -1] + 17) % model.config.vocab_size
    with torch.no_grad():
        reference = model.forward_multi_pass(
    ...
    checks = {
        "b1_gate_parameter_absent": "g_rec" not in dict(model.named_parameters()),
        "b1_gate_state_absent": "g_rec" not in model.state_dict(),
        "b1_w2_exact": int(b1_local.sum(-1).max()) == min(2, length),
        "b2_w32_exact": int(b2_local.sum(-1).max()) == min(32, length),
        "b2_recurrent_mask_exact": torch.equal(b2_recurrent, expected_b2),
        "b2_local_recurrent_disjoint": not bool((b2_local & b2_recurrent).any()),
        "b2_partition_exact": torch.equal(b2_local | b2_recurrent, source <= query),
        "b11_source_not_repeated": bank.values.data_ptr() == values.data_ptr(),
        "b11_source_rank_three": bank.values.ndim == 3,
        "b2_shared_projection_exact": torch.equal(key, expected_key)
        and torch.equal(value, expected_value),
        "single_c_proj_each": calls == {"b1": 1, "b2": 1},
        "b1_recurrent_diagnostic_absent": active["diagnostics"]["b1"][
            "recurrent_path_present"
        ] is False,
        "b2_invalid_probabilities_zero": not bool(
            weights.masked_select(~b2_recurrent.view(1, 1, length, length)).count_nonzero()
        ),
        "b2_probabilities_finite": bool(torch.isfinite(weights).all()),
        "b2_gate_zero_identity": torch.equal(plain, zero),
        "future_perturbation_causal": torch.equal(reference[:, :-1], perturbed[:, :-1]),
    }
    reports = {
        "b2_boundary_counts": {
            str(position): int(model.b2_recurrent_mask(T, T, device)[position].sum())
            for position in (0, 31, 32, 100, 1023)
        },
        "c_proj_calls": calls,
        "b12_recurrent_ring_present": False,
    }
    del values, bank, key, value, active, weights, reference, perturbed
    torch.cuda.empty_cache()
    return {"checks": checks, "reports": reports, "passed": all(checks.values())}
...
def frozen_2d2b_regression(model, source_payload, val_path) -> dict:
    ...
    old_model.g_rec.data.copy_(source_payload["g_rec"].to(old_model.g_rec.device))
    ...
    checks = {
        ...
        "source_b1_gate_exact": old_model.g_rec.detach().float().item() == SOURCE_GATE_RAW,
        "target_b1_gate_absent": "g_rec" not in dict(model.named_parameters()),
    }
    report = {
...
def probe_microbatch(model, optimizer, shards, device, candidates=(32, 16, 8, 4, 2)):
    ...
    for candidate in candidates:
        ...
        try:
            ...
            del results, source_h11, loss, x, y, cpu_x, cpu_y
            gc.collect()
            torch.cuda.empty_cache()
    raise SystemExit(f"no safe 2D2H microbatch: {attempts}")
...
def run_preflight(args):
    ...
    if not optimizer_match["passed"]:
        raise SystemExit(
            f"2D2H optimizer differs from frozen matched 2D2C: {optimizer_match['checks']}"
        )
    ...
    durable_json(
        ...
        {
            "schema": "exp2d2h_storage_cleanup_manifest_v1",
            "preflight_cleanup": {
                "action_provenance": (
    ...
    zero_shot["matched_2d2c_comparison"] = {
        "gain_W32_minus_gain_W2": zero_shot["b2_recurrent_gain"]
        - FROZEN_2D2C_REFERENCE["gain_trajectory"]["0"],
        "sequence_gap_W32_minus_sequence_gap_W2": zero_shot["b2_sequence_gap"]
    ...
    if (
        ...
        raise SystemExit(
            "2D2H did not preserve frozen one-GPU 2D2C microbatch/reduction geometry"
        )
    ...
    if not preflight["science_passed"]:
        raise SystemExit(f"2D2H preflight failed: {science_checks}")
    print("EXPERIMENT_2D2H_PREFLIGHT_PASS", flush=True)
    return preflight


def run_preflight(args):
    """Authorize 2D2H after exact source, architecture, data and lane audits."""
    ...
    semantic = semantic_diff_audit(model, source_payload)
    val_path = validation_path(args.data_root)
    source_regression = frozen_2d2b_regression(model, source_payload, val_path)
    zero = evaluate_parallel(model, val_path)
    source_loss = source_regression["observed_parallel"]["full_real"]
    off_loss = zero["controls"]["b2_recurrence_off"]["validation_loss"]
    initial = {
        "source_2d2b_real_loss": source_loss,
        "h_b1_w2_no_recurrence_b2_w32_gate_zero_loss": off_loss,
        "initial_combined_damage": off_loss - source_loss,
        "gate_zero_real_identity": zero["controls"]["new_real"]["validation_loss"]
        == off_loss,
        "gate_zero_shuffled_identity": zero["controls"]["b2_shuffled"][
            "validation_loss"
        ]
        == off_loss,
    }
    initial["passed"] = initial["gate_zero_real_identity"] and initial[
        "gate_zero_shuffled_identity"
    ]
    short_loader = legacy.d1.ExplicitShardLoader([val_path], 2, 64)
    short_x, short_y = short_loader.next_batch()
    kernel = kernel_preflight(model, short_x.to(device), short_y.to(device))
    temporal = temporal_gradient_by_lag(
        model, val_path, "b2", precision="bf16", b2_gate_override=0.05
    )
    attention = attention_diagnostics(model, val_path, "b2")
    micro_batch, probe = probe_microbatch(
        model, optimizer, source_payload["loader_state"]["shards"], device
    )
    accumulation = GLOBAL_TARGETS // (micro_batch * T)
    performance_benchmark = {
        "recurrent_attention": benchmark_recurrent_attention(model, micro_batch),
        "b2_local_attention": benchmark_b2_local_attention(model, micro_batch),
    }
    scientific_loader = loader_at_source_cursor(
        source_payload["loader_state"], micro_batch
    )
    ...
    data_match = {
        ...
        "source_next_global_batch_sha256": SOURCE_NEXT_BATCH_SHA256,
        "source_next_global_batch_stream_sha256": SOURCE_NEXT_STREAM_SHA256,
        "observed_source_stream_sha256": source_stream,
        "observed_scientific_stream_sha256": scientific_stream,
        "same_first_batch": source_audit["next_global_batch_sha256"]
        == SOURCE_NEXT_BATCH_SHA256,
        "same_target_stream": source_stream == scientific_stream
        == SOURCE_NEXT_STREAM_SHA256,
    ...
    checks = {
        ...
        "parameters_exact": parameters["passed"],
        "architecture_exact": semantic["passed"] and kernel["passed"],
        "b1_recurrence_physically_absent": architecture["links"]["B12_to_B1"][
            "present"
        ] is False,
        "initial_damage_measured": initial["passed"],
        "matched_2d2d_data": data_match["passed"],
        "b2_long_writer_gradient": temporal["finite"]
        and temporal["nonzero"]
        and temporal["long_lag_writer_gradient_present"],
        "attention_finite": attention["weights_finite"],
        "global_batch_exact": micro_batch * T * accumulation == GLOBAL_TARGETS,
        "persistent_workspace": mount["passed"],
        "authenticated_stop": stop["driver_passed"],
    }
    preflight = {
        ...
        "semantic_diff": semantic,
        "kernel_preflight": kernel,
        "source_2d2b_regression": source_regression,
        "initial_combined_damage": initial,
        "matched_2d2d_data_audit": data_match,
        "temporal_gradient_preflight": {"b2_probe": temporal},
        "attention_zero_shot": {"b2": attention},
        "microbatch_probe": probe,
        "selected_microbatch": micro_batch,
        "gradient_accumulation": accumulation,
        "performance_benchmark": performance_benchmark,
        "runpod_stop_audit": stop,
        "persistent_workspace_audit": mount,
        "checks": checks,
        "science_passed": all(checks.values()),
        "result_run_authorized": all(checks.values()),
        "wall_seconds": time.monotonic() - started,
    }
    durable_json(output / "source_manifest.json", {**source_audit, "frozen_commit": FROZEN_COMMIT})
    durable_json(output / "parameter_manifest.json", parameters)
    durable_json(output / "architecture_manifest.json", architecture)
    durable_json(output / "semantic_diff_audit.json", semantic)
    durable_json(output / "matched_2d2d_data_audit.json", data_match)
    durable_json(output / "initial_combined_damage.json", initial)
    durable_json(
        output / "batch_manifest.json",
        {
            "selected_micro_batch_sequences": micro_batch,
            "selected_gradient_accumulation": accumulation,
            "global_targets_per_update": GLOBAL_TARGETS,
            "sequence_length": T,
            "probe_attempts": probe,
            "passed": micro_batch * accumulation * T == GLOBAL_TARGETS,
        },
    )
    durable_json(
        output / "distributed_equivalence.json",
    ...
    durable_json(output / "b2_recurrent_attention_lag_bins.json", {"0": attention["lag_bins"]})
    durable_json(output / "b2_local_attention_lag_bins.json", {"0": attention["local_lag_bins"]})
    durable_json(output / "b2_attention_head_distance.json", {"0": {"heads": attention["heads"], "aggregate": attention["aggregate"], "mass_partitions": attention["mass_partitions"]}})
    durable_json(output / "b11_to_b2_temporal_gradient.json", {"0_probe": temporal})
    durable_json(output / "checkpoint_manifest.json", {"scientific": {}, "recovery": {}, "smoke": {}})
    durable_json(output / "runpod_stop_capability.json", stop)
    durable_json(output / "persistent_workspace_audit.json", mount)
    durable_json(
        output / "storage_cleanup_manifest.json",
        {
            "cleanup_actions": [],
            "cleanup_actions_after_preflight": [],
            "scientific_files_deleted": False,
        },
    )
    durable_json(output / "preflight_audit.json", preflight)
    if not preflight["science_passed"]:
        raise SystemExit(f"2D2H preflight failed: {checks}")
    print("EXPERIMENT_2D2H_PREFLIGHT_PASS", flush=True)
    return preflight
...
def checkpoint_payload(model, optimizer, loader, training_state, metadata, accumulation):
    return {
        ...
        "completed_2d2h_updates": training_state["completed_2d2h_updates"],
        "processed_2d2h_targets": training_state["processed_2d2h_targets"],
...
def strict_reopen_checkpoint(
    ...
    required = {
        ...
        "g_rec_b2",
        "optimizer",
        "completed_2d2h_updates",
        "processed_2d2h_targets",
        "cumulative_2d2_targets",
        "source_2d2b_updates",
        "source_2d2b_targets",
        "training_state",
    ...
    checks = {
        ...
        "updates": reopened.get("completed_2d2h_updates")
        == training_state["completed_2d2h_updates"],
        "additional_targets": reopened.get("processed_2d2h_targets")
        == training_state["processed_2d2h_targets"],
    ...
    verification = {
        ...
        "bytes": path.stat().st_size,
        "completed_2d2h_updates": reopened["completed_2d2h_updates"],
...
def run_smoke(args):
    ...
    with torch.no_grad():
        ...
        cache = model.incremental_logits(
            cache_x[:, :64].to(device), control="real", bank_mode="full"
        )["cache_audit"]
    state = {
        "completed_2d2h_updates": 3,
        "processed_2d2h_targets": 3 * smoke_batch * T,
    ...
    path = Path(args.ephemeral_checkpoint_root).resolve() / "smoke_update_0003.pt"
    ...
    checks = {
        ...
        "b1_gate_physically_absent": "g_rec" not in dict(model.named_parameters()),
    ...
    audit = {
        ...
        "command": " ".join(sys.argv),
        "rows": rows,
        "long_lag_temporal_gradient": {"b2": temporal_b2},
    ...
    if not audit["passed"]:
        raise SystemExit(f"2D2H smoke failed: {checks}")
    ...
    durable_json(output / "smoke_audit.json", audit)
    print("EXPERIMENT_2D2H_SMOKE_PASS", flush=True)
    return audit
...
def initialize_runtime(args):
    ...
    if args.resume:
        ...
        if state["completed_2d2h_updates"] != FORCED_RESTART_UPDATE:
        ...
        restart = {
            ...
            "completed_2d2h_updates": state["completed_2d2h_updates"],
        ...
        state = {
            "completed_2d2h_updates": 0,
            "processed_2d2h_targets": 0,
        ...
        saved_pid = None
    if state["completed_2d2h_updates"] == 0:
    ...
    return SimpleNamespace(
        ...
        ephemeral_checkpoint_root=str(Path(args.ephemeral_checkpoint_root).resolve()),
        checkpoint_persist_lock=str(Path(args.checkpoint_persist_lock).resolve()),
    )
...
def train_one_update(runtime, update):
    ...
    elapsed = time.monotonic() - start
    runtime.training_state["completed_2d2h_updates"] = update
    runtime.training_state["processed_2d2h_targets"] = update * GLOBAL_TARGETS
...
def milestone_diagnostics(runtime, update, val_path):
    ...
    initial_damage = read_json(
        runtime.output / "initial_combined_damage.json"
    )["initial_combined_damage"]
    validation["recurrent_recovery_fraction"] = (
        validation["b2_recurrent_gain"] / initial_damage
        if initial_damage > 0
        else None
    )
    ...
    temporal_b2.update({"local_update": update, "additional_targets": update * GLOBAL_TARGETS, "cumulative_2d2_targets": SOURCE_TARGETS + update * GLOBAL_TARGETS})
    ...
    runtime.model.train()
    return validation, {"b2": attention_b2}, {"b2": temporal_b2}
...
def reconcile_uncheckpointed_artifacts(output, completed):
    ...
    output = Path(output)
    audit = {
        "schema": "exp2d2h_resume_reconciliation_v1",
...
def run_train(args):
    ...
    completed = int(runtime.training_state["completed_2d2h_updates"])
    ...
    if int(args.end_update) == FORCED_RESTART_UPDATE:
        print("EXPERIMENT_2D2H_UPDATE_96_RESTART_REQUIRED", flush=True)
    else:
        durable_json(
            runtime.output / "training_complete.json",
            {
                "completed_2d2h_updates": MAX_UPDATES,
                "processed_2d2h_targets": ADDITIONAL_TARGETS,
                "cumulative_2d2_targets": CUMULATIVE_TARGETS,
                "checkpoint": runtime.training_state["last_checkpoint"],
                "timestamp": time.time(),
            },
        )
        print("EXPERIMENT_2D2H_TRAINING_COMPLETE", flush=True)
    return segment
...
def evaluate_incremental(model, val_path, batches=INCREMENTAL_BATCHES) -> dict:
    ...
    for batch_index in range(batches):
        ...
        print(f"2D2H incremental batch={batch_index + 1:02d}/{batches}", flush=True)
        del x, y, cpu_x, cpu_y
        torch.cuda.empty_cache()
    elapsed = time.monotonic() - start
    controls = {}
...
def parallel_incremental_equivalence(model, val_path, length=64, batch=2):
    if length < 64:
        raise ValueError("2D2H equivalence requires length >=64 to exercise B2 W32 eviction")
...
def memory_accounting(incremental=None) -> dict:
    ...
    if incremental is not None:
        final_cache = incremental["controls"]["both_real"]["cache_rows"][-1][
            "final"
        ]
        cache_bytes = sum(
            0
...
def load_final_model(args, device):
    ...
    if payload.get("completed_2d2h_updates") != MAX_UPDATES:
    ...
    audit = {
        ...
        "completed_2d2h_updates": payload["completed_2d2h_updates"],
        "processed_2d2h_targets": payload["processed_2d2h_targets"],
...
def classify_result(incremental, stable=True, integrity=True) -> str:
    if not integrity:
        return "EXPERIMENT 2D2H INVALID"
    if not stable:
    ...
    gain = incremental["true_b2_recurrent_gain"]
    gap = incremental["true_b2_sequence_gap"]
    positive = (
        gain > 0
        and gap > 0
...
def choose_recommendation(classification, initial_damage) -> str:
    if classification == "EXPERIMENT 2D2H INVALID":
        return "FIX 2D2H INTEGRITY"
...
def _incremental_control(model, x, y, name, derangement=None):
    """Evaluate one physical 2D2H incremental condition without prefix replay."""
    if name not in INCREMENTAL_CONTROLS:
        raise ValueError(name)
    batch, length = x.shape
    state = model.init_incremental_state(
        batch, device=x.device, b2_full_cache=name == "b2_full_counterfactual"
    )
    sequence_sums = torch.zeros(batch, dtype=torch.float64)
    position_sums = np.zeros(length, dtype=np.float64)
    total = 0.0
    max_cache = [0] * N_LAYER
    max_h11 = 0
    b2_rms = []
    for position in range(length):
        logits, state, diagnostics = model.incremental_step(
            ...
            state,
            control=name,
            recurrent_permutation=derangement if name == "b2_shuffled" else None,
            return_diagnostics=True,
            bank_mode="full",
            diagnostic_attention_weights=False,
        )
        losses = F.cross_entropy(logits[:, 0].float(), y[:, position], reduction="none")
        cpu_losses = losses.detach().double().cpu()
        sequence_sums += cpu_losses
        position_sums[position] = cpu_losses.sum().item()
        total += cpu_losses.sum().item()
        lengths = model.incremental_cache_lengths(state)
        max_cache = [max(a, b) for a, b in zip(max_cache, lengths)]
        max_h11 = max(max_h11, int(state.h11_ring.size(1)))
        if diagnostics.get("b2") is not None:
            b2_rms.append(
                diagnostics["b2"]["recurrent_output_rms"].detach().float().item()
            )
    audit = model.incremental_cache_audit(state)
    if hasattr(state, "h12_ring") or audit.get("h12_recurrent_ring_present"):
        raise RuntimeError("2D2H incremental state illegally contains a B12 ring")
    return {
        "loss_sum": total,
        "targets": batch * length,
        "per_sequence_losses": (sequence_sums / length).tolist(),
        "per_position_sum": position_sums,
        "final_cache_audit": audit,
        "max_cache_lengths": max_cache,
        "max_h11_ring_length": max_h11,
        "final_h11_memory_rms": (
            state.h11_ring.float().square().mean().sqrt().item()
            if state.h11_ring.numel() else 0.0
        ),
        "mean_b2_recurrent_output_rms": statistics.fmean(b2_rms) if b2_rms else 0.0,
    }


@torch.no_grad()
def evaluate_incremental(model, val_path, batches=INCREMENTAL_BATCHES) -> dict:
    """Run the preregistered four-condition 262,144-target/control evaluation."""
    model.eval()
    device = next(model.parameters()).device
    loader = legacy.d1.ExplicitShardLoader([val_path], VALIDATION_B, T)
    ...
    for batch_index in range(batches):
        ...
        for name in names:
            ...
            with context:
                current = _incremental_control(model, x, y, name, derangement)
            row = rows[name]
            row["loss_sum"] += current["loss_sum"]
            row["targets"] += current["targets"]
    ...
    real, off = controls["real"], controls["b2_recurrence_off"]
    shuffled, full = controls["b2_shuffled"], controls["b2_full_counterfactual"]
    result = {
        "controls": controls,
        "true_b2_recurrent_gain": off["validation_loss"] - real["validation_loss"],
        "true_b2_sequence_gap": shuffled["validation_loss"] - real["validation_loss"],
        "true_remaining_b2_compression_gap": real["validation_loss"] - full["validation_loss"],
        "real_vs_b2_off_batches": paired_stats(real["per_batch_losses"], off["per_batch_losses"]),
        "real_vs_b2_shuffled_batches": paired_stats(real["per_batch_losses"], shuffled["per_batch_losses"]),
        "real_vs_b2_full_batches": paired_stats(real["per_batch_losses"], full["per_batch_losses"]),
        "real_vs_b2_off_sequences": paired_stats(real["per_sequence_losses"], off["per_sequence_losses"]),
        "real_vs_b2_shuffled_sequences": paired_stats(real["per_sequence_losses"], shuffled["per_sequence_losses"]),
        "real_vs_b2_full_sequences": paired_stats(real["per_sequence_losses"], full["per_sequence_losses"]),
        "g_rec_b2_raw": model.g_rec_b2.detach().float().item(),
        "tanh_g_rec_b2": model.recurrent_scale_b2.detach().float().item(),
        "b1_recurrent_gate_present": False,
        "canonical_subset_sha256": legacy.d0.aggregate_hashes([r["combined_sha256"] for r in identities]),
        "batch_identities": identities,
        "batch_count": batches,
        "batch_size": VALIDATION_B,
        "sequence_length": T,
        "targets_per_control": batches * VALIDATION_B * T,
        "minimum_target_requirement_met": batches * VALIDATION_B * T >= 262_144,
        "precision": "teacher-forced true incremental BF16",
        "no_complete_prefix_recomputation": True,
        "performance": {
            "wall_seconds": time.monotonic() - started,
...
def parallel_incremental_equivalence(model, val_path, length=64, batch=2):
    ...
    for name, (parallel, incremental) in comparisons.items():
        ...
        report[name] = {
            ...
            "pre_recurrence_positions_0_31_max_abs": delta[:, :32].max().item(),
...
def memory_accounting(incremental=None) -> dict:
    def deployment(batch):
        b1 = batch * 1 * N_EMBD * 2 * 2
        b2 = batch * 31 * N_EMBD * 2 * 2
        b11 = batch * 1023 * N_EMBD * 2
        upper = batch * 10 * 1023 * N_EMBD * 2 * 2
        total = b1 + b2 + b11 + upper
        return {
            "batch_size": batch,
            "b1_local_kv_bytes": b1,
            "b2_local_kv_bytes": b2,
            "b11_recurrent_raw_state_bytes": b11,
            "b12_recurrent_raw_state_bytes": 0,
            "b3_b12_ordinary_kv_bytes": upper,
            "total_experimental_inference_state_bytes": total,
            "mib": {"total": total / 1024**2},
        }
    observed = None
    if incremental is not None:
        audit = incremental["controls"]["real"]["cache_rows"][-1]["final"]
        cache_bytes = sum(0 if row["key"] is None else row["key"]["actual_bytes"] + row["value"]["actual_bytes"] for row in audit["cache_physical_storage"])
        ring_bytes = audit["h11_ring_physical_storage"]["actual_bytes"]
        observed = {"control": "real", "cache_bytes": cache_bytes, "raw_ring_bytes": ring_bytes, "total_physical_state_bytes": cache_bytes + ring_bytes, "b12_ring_present": False}
    return {
        "deployment_accounting_dtype": "BF16",
        "bytes_per_element": 2,
        "B1": deployment(1),
        "B64": deployment(64),
        "observed_final_incremental_storage": observed,
        "state_limits": {"B1 ordinary historical KV": 1, "B2 ordinary historical KV": 31, "B11 raw recurrent states": 1023, "B12 raw recurrent states": 0, "B3-B12 ordinary historical KV each": 1023},
    }
...
def load_final_model(args, device):
    ...
    micro_batch = int(batch_manifest["selected_micro_batch_sequences"])
    accumulation = int(batch_manifest["selected_gradient_accumulation"])
    model, optimizer, _, _, _ = load_source_bundle(args.source_checkpoint, device, restore_rng=False)
    payload = legacy.d0.torch_load(Path(args.final_checkpoint).resolve(), mmap=False)
    if payload.get("schema") != CHECKPOINT_SCHEMA or payload.get("completed_2d2h_updates") != MAX_UPDATES:
        raise SystemExit("final 2D2H checkpoint schema/update mismatch")
    if payload.get("metadata") != training_metadata(args, preflight, micro_batch, accumulation):
        raise SystemExit("final checkpoint metadata mismatch")
    model.load_state_dict(payload["model"], strict=True)
    optimizer.load_state_dict(payload["optimizer"])
    path = Path(args.final_checkpoint).resolve()
    audit = {
        "checkpoint": str(path), "sha256": file_sha256(path), "bytes": path.stat().st_size,
        "completed_2d2h_updates": payload["completed_2d2h_updates"],
        "processed_2d2h_targets": payload["processed_2d2h_targets"],
        "cumulative_2d2_targets": payload["cumulative_2d2_targets"],
        "model_finite": model_finite(model), "optimizer_finite": optimizer_finite(optimizer),
        "b1_recurrent_gate_present": hasattr(model, "g_rec"),
        "g_rec_b2_raw": model.g_rec_b2.detach().float().item(),
        "tanh_g_rec_b2": model.recurrent_scale_b2.detach().float().item(),
    }
    sidecar = path.with_suffix(path.suffix + ".sha256").read_text().split()[0]
    audit["passed"] = audit["sha256"] == sidecar and audit["model_finite"] and audit["optimizer_finite"] and not audit["b1_recurrent_gate_present"]
    return model, optimizer, audit
...
def classify_result(incremental, stable=True, integrity=True) -> str:
    ...
    if not stable:
        return "B2 W32 SECOND LINK IS UNSTABLE"
    off = incremental["real_vs_b2_off_sequences"]["wins"]
    shuffled = incremental["real_vs_b2_shuffled_sequences"]["wins"]
    gain, gap = incremental["true_b2_recurrent_gain"], incremental["true_b2_sequence_gap"]
    if gain > 0 and gap > 0 and off >= 129 and shuffled >= 129:
        if gain >= 0.001 and off >= 166 and shuffled >= 166:
            return "W32 STRONGLY RESCUES B11→B2 RECURRENT UTILITY"
        return "B2 W32 ESTABLISHES POSITIVE SECOND-LINK RECURRENT UTILITY"
    if gap > 0:
        return "B2 W32 RECURRENCE IS SEQUENCE-SPECIFIC BUT DOES NOT ESTABLISH UTILITY"
    if gain < 0 and off < 128:
        return "B2 W32 SECOND RECURRENT LINK IS HARMFUL"
    return "B2 W32 SECOND RECURRENT LINK REMAINS NEAR ZERO"
...
def self_composition_diagnostic(model, val_path, passes=8, batch_size=2) -> dict:
    ...
    device = next(model.parameters()).device
    x, y = cpu_x.to(device), cpu_y.to(device)
    source_h11, rows = None, []
    for pass_index in range(passes):
        current = model.forward_pass(x, b2_recurrent_source=source_h11, return_diagnostics=pass_index > 0, bank_mode="full")
        rows.append({
            "pass": pass_index + 1,
            "loss": _token_losses(current["logits"], y).double().mean().item(),
            "b11_memory_rms": current["h11"].float().square().mean().sqrt().item(),
            "b2_recurrent_output_rms": current["diagnostics"]["b2"]["recurrent_output_rms"].float().item() if pass_index else 0.0,
            "b12_recurrent_ring_present": False,
        })
        source_h11 = current["h11"]
    return {"passes": rows, "batch_size": batch_size, "sequence_length": T, "finite": _numbers_finite(rows), "no_gradient": True, "b1_recurrence_absent": True}
...
def make_plots(output, milestones, training, incremental, attention, temporal, performance):
    ...
    def line_plot(filename, series, ylabel):
        ...
        ax.set_xlabel("Additional 2D2H training targets")
    ...
    gains = [milestones[str(k)]["b2_recurrent_gain"] for k in keys]
    gaps = [milestones[str(k)]["b2_sequence_gap"] for k in keys]
    ...
    ax.set(xlabel="Additional 2D2H training targets", ylabel="tanh(g_rec_B1)")
    ax.grid(alpha=0.25)
    ax.legend()
    fig.tight_layout()
    ...
    ax.plot(tx, [row["tanh_g_rec_b2"] for row in training], label="2D2H W32")
    ax.plot(
        milestone_targets,
    ...
    ax.bar(
        ...
        [milestones[str(MAX_UPDATES)]["b2_recurrent_gain"], incremental["true_b2_recurrent_gain"]],
    )
...
def build_questions(
    ...
    return {
        ...
        "Q19": {"question": "What is final parallel B2-W32 sequence gap?", "answer": parallel["b2_sequence_gap"]},
        "Q20": {"question": "How does final parallel gain compare with matched W2 2D2C?", "answer": {"W32": parallel["b2_recurrent_gain"], "W2": FROZEN_2D2C_REFERENCE["final_parallel_gain"], "difference": parallel["b2_recurrent_gain"] - FROZEN_2D2C_REFERENCE["final_parallel_gain"]}},
        ...
        "Q30": {"question": "What is final true-incremental B2-W32 recurrent gain?", "answer": incremental["true_b2_recurrent_gain"]},
        "Q31": {"question": "What is final true-incremental B2-W32 sequence gap?", "answer": incremental["true_b2_sequence_gap"]},
        "Q32": {"question": "What are paired true-self wins versus B2 Off?", "answer": incremental["both_real_vs_b2_off_sequences"]},
        "Q33": {"question": "What are paired wins versus B2 Shuffled?", "answer": incremental["both_real_vs_b2_shuffled_sequences"]},
...
def incremental_position_bins(incremental):
    ...
    for name, first, last in POSITION_BINS:
        ...
        result[name] = {
            "real_loss": float(values["real"].mean()),
            ...
            "b2_recurrent_gain": float(
                (values["b2_recurrence_off"] - values["real"]).mean()
            ),
            "b2_sequence_gap": float(
                (values["b2_shuffled"] - values["real"]).mean()
            ),
            "remaining_b2_compression_gap": float(
                (values["real"] - values["b2_full_counterfactual"]).mean()
            ),
        }
    return result
...
def render_report(summary, audit, questions):
    ...
    lines = [
        f"EXPERIMENT 2D2H PRIMARY CLASSIFICATION:\n{summary['primary_classification']}",
        ...
        "\n# Experiment 2D2H — B2 W32 + Older B11→B2 Recurrent K/V",
        "\n## Result",
        ...
        f"- Paired Real vs B2-shuffled: {json.dumps(parallel['new_real_vs_b2_shuffled'], sort_keys=True)}",
        ...
        f"\n- Final gain W32 − W2: {parallel['b2_recurrent_gain'] - FROZEN_2D2C_REFERENCE['final_parallel_gain']}",
        f"- Final sequence gap W32 − W2: {parallel['b2_sequence_gap'] - FROZEN_2D2C_REFERENCE['final_parallel_sequence_gap']}",
...
def build_integrity_checks(
    ...
    checks = {
        ...
        "parameter count 124,475,906": preflight["parameters"]["2d2d_total_parameters"] == TOTAL_PARAMETERS,
        ...
        "191 additional optimizer updates": final_model_audit["completed_2d2h_updates"] == 191,
        "100,139,008 additional targets": final_model_audit["processed_2d2h_targets"] == ADDITIONAL_TARGETS,
...
def run_finalize(args):
    ...
    if training_complete["completed_2d2h_updates"] != MAX_UPDATES:
    ...
    if not scientific_integrity or not inventory["passed"]:
        raise SystemExit(
            f"2D2H finalize integrity failed: scientific={scientific_integrity} inventory={inventory['passed']}"
        )
    print("EXPERIMENT_2D2H_FINALIZED_PENDING_GIT_SEAL", flush=True)
    return summary
...
def run_seal_report(args):
    ...
    print("EXPERIMENT_2D2H_REPORT_SEALED", flush=True)
...
def run_attest_seal(args):
    ...
    print("EXPERIMENT_2D2H_SEAL_ATTESTED", flush=True)


def make_2d2h_plots(output, milestones, training, incremental, attention, temporal, memory):
    """Emit the preregistered compact diagnostic plot set."""
    ...
    output = Path(output)
    updates = sorted(int(key) for key in milestones)
    rows = [milestones[str(update)] for update in updates]
    real = [row["controls"]["new_real"]["validation_loss"] for row in rows]
    off = [row["controls"]["b2_recurrence_off"]["validation_loss"] for row in rows]
    gain = [row["b2_recurrent_gain"] for row in rows]
    gap = [row["b2_sequence_gap"] for row in rows]
    gate = [0.0] + [row["tanh_g_rec_b2"] for row in training if row["local_update"] in updates[1:]]
    final_attention = attention[str(MAX_UPDATES)]
    final_gradient = temporal[str(MAX_UPDATES)]["bins"]

    def line(index, series, ylabel):
        fig, ax = plt.subplots(figsize=(7.0, 4.2))
        for label, values in series.items():
            ax.plot(updates[: len(values)], values, marker="o", label=label)
        ax.set_xlabel("Local update")
        ax.set_ylabel(ylabel)
        if len(series) > 1:
            ax.legend()
        ax.grid(alpha=0.25)
        fig.tight_layout()
        fig.savefig(output / REQUIRED_PLOTS[index], dpi=160)
        plt.close(fig)

    def bars(index, labels, values, ylabel):
        fig, ax = plt.subplots(figsize=(7.0, 4.2))
    ...
    line(0, {"Real": real, "B2 Off": off}, "Validation CE")
    line(1, {"Off − Real": gain}, "Recurrent gain")
    line(2, {"Shuffled − Real": gap}, "Sequence gap")
    bars(3, ["2D2D", "2D2H"], [FROZEN_2D2D_REFERENCE["true_incremental_gain"], incremental["true_b2_recurrent_gain"]], "True incremental gain")
    line(4, {"B1 gate (removed)": [0.0] * len(updates), "B2 gate": gate}, "tanh(g_rec)")
    bars(5, ["2D2D B2", "2D2H B2"], [FROZEN_2D2D_REFERENCE["final_tanh_g_rec_b2"], incremental["tanh_g_rec_b2"]], "Final gate")
    labels = list(final_attention)
    bars(6, labels, [final_attention[name]["attention_mass"] for name in labels], "Attention mass")
    bars(7, labels, [final_attention[name]["normalized_mass_per_available_token"] for name in labels], "Mass / available token")
    local = read_json(output / "b2_local_attention_lag_bins.json")[str(MAX_UPDATES)]
    bars(8, list(local), [local[name]["attention_mass"] for name in local], "B2 local attention mass")
    bars(9, list(final_gradient), [final_gradient[name]["mean_gradient_rms"] for name in final_gradient], "Writer gradient RMS")
    heads = read_json(output / "b2_attention_head_distance.json")[str(MAX_UPDATES)]["heads"]
    bars(10, list(heads), [heads[name]["mean_attended_recurrent_lag"] for name in heads], "Mean attended lag")
    bars(11, ["Parallel", "Incremental"], [rows[-1]["b2_recurrent_gain"], incremental["true_b2_recurrent_gain"]], "Recurrent gain")
    bars(12, ["B=1", "B=64"], [memory["B1"]["mib"]["total"], memory["B64"]["mib"]["total"]], "Inference state MiB")
    bars(13, ["targets/s", "peak GiB"], [statistics.fmean(row["targets_per_second"] for row in training), max(row["peak_reserved_vram_mb"] for row in training) / 1024], "Runtime scale")


def run_finalize(args):
    """Finalize only after the exact update-191 checkpoint passes all audits."""
    ...
    model, optimizer, checkpoint = load_final_model(args, device)
    checkpoint_manifest = read_json(output / "checkpoint_manifest.json")
    recorded = checkpoint_manifest["scientific"].get(str(MAX_UPDATES), {})
    if recorded.get("sha256") != checkpoint["sha256"]:
        raise SystemExit("final checkpoint manifest mismatch")
    ...
    training = read_jsonl(output / "training_metrics.jsonl")
    if len(training) != MAX_UPDATES or training[-1]["local_update"] != MAX_UPDATES:
        raise SystemExit("training metrics are not the exact 191-update trajectory")
    ...
    cache_bounds_passed = all(
        row["final"]["b1_historical_kv"] <= 1
        and row["final"]["b2_historical_kv"] <= 31
        and row["final"]["h11_ring_length"] <= 1023
        and row["final"]["h12_recurrent_ring_present"] is False
        and row["max_h12_ring_length"] == 0
        for row in real_cache_rows
    )
    stable = stability["finite"] and _numbers_finite(incremental)
    integrity_checks = {
        "preflight": bool(preflight["science_passed"]),
        "final_checkpoint": bool(checkpoint["passed"]),
        "exact_parameter_count": sum(p.numel() for p in model.parameters())
        == TOTAL_PARAMETERS,
        "b1_gate_absent": "g_rec" not in dict(model.named_parameters()),
        "b1_gate_optimizer_state_absent": all(
            parameter is not getattr(model, "g_rec_b2", None)
            for group in optimizer.param_groups
            if group.get("name") != "b2_gate"
            for parameter in group["params"]
        ),
        "incremental_target_count": incremental["targets_per_control"] == 262_144,
        "incremental_cache_bounds": cache_bounds_passed,
        "parallel_incremental_equivalence": bool(equivalence["passed"]),
        "eight_pass_stability": bool(stable),
        "writer_gradient": bool(temporal[str(MAX_UPDATES)]["finite"])
        and bool(temporal[str(MAX_UPDATES)]["long_lag_writer_gradient_present"]),
        "attention_finite": _numbers_finite(attention[str(MAX_UPDATES)]),
        "all_training_states_finite": all(
    ...
    recommendation = choose_recommendation(
        classification, initial["initial_combined_damage"]
    )

    cache_audit = {
        "real_controls": real_cache_rows,
        "counterfactual_full_cache_is_diagnostic_only": True,
        "bounds": {
            "b1_historical_kv": 1,
            "b2_historical_kv": 31,
            "b11_raw_ring": 1023,
            "b12_raw_ring": 0,
            "b3_b12_historical_kv_each": 1023,
        },
        "passed": cache_bounds_passed,
    }
    paired = {
        "parallel": {
            "real_vs_off": parallel["new_real_vs_b2_off"],
            "real_vs_shuffled": parallel["new_real_vs_b2_shuffled"],
            "real_vs_full_counterfactual": parallel["new_real_vs_b2_full"],
        },
        "true_incremental": {
            key: incremental[key]
            for key in (
                "real_vs_b2_off_batches", "real_vs_b2_shuffled_batches",
                "real_vs_b2_full_batches", "real_vs_b2_off_sequences",
                "real_vs_b2_shuffled_sequences", "real_vs_b2_full_sequences",
            )
        },
    }
    gate = {
        "source_b1_gate_removed": True,
        "source_b1_gate_raw": SOURCE_GATE_RAW,
        "trajectory": [
            {
                "local_update": row["local_update"],
                "g_rec_b2_raw": row["g_rec_b2_raw"],
        ...
        "final_g_rec_b2_raw": checkpoint["g_rec_b2_raw"],
        "final_tanh_g_rec_b2": checkpoint["tanh_g_rec_b2"],
    }
    performance = build_performance(training, milestones, incremental, preflight)
    summary = {
        "experiment": EXPERIMENT,
        ...
        "recommendation": recommendation,
        "source_checkpoint_sha256": SOURCE_SHA256,
        "final_checkpoint": checkpoint["checkpoint"],
        ...
        "pod": {
            "id": args.pod_id,
            "name": args.pod_name,
            "stop_only_after_local_sync_and_commit": True,
            "delete_authorized": False,
        },
    }
    commands = {
        "preflight": preflight["command"] if "command" in preflight else None,
        "smoke": read_json(output / "smoke_audit.json")["command"],
        "training_segments": read_json(output / "process_segments.json"),
        "finalize": " ".join(sys.argv),
        "exact_stop_command": f"runpodctl pod stop {args.pod_id} -o json",
        "pod_delete_authorized": False,
    }
    report = f"""# Experiment 2D2H — Final Report
...
- Recommendation: {recommendation}
- Source: exact final 2D2B `{SOURCE_SHA256}`
- Final checkpoint: `{checkpoint['sha256']}`
- Parameters: {TOTAL_PARAMETERS:,}
...
- Initial combined damage: {initial['initial_combined_damage']:.12g}
- True incremental Real: {incremental['controls']['real']['validation_loss']:.12g}
- True incremental B2-Off: {incremental['controls']['b2_recurrence_off']['validation_loss']:.12g}
- True incremental B2-Shuffled: {incremental['controls']['b2_shuffled']['validation_loss']:.12g}
- True recurrent gain: {incremental['true_b2_recurrent_gain']:+.12g}
- True sequence gap: {incremental['true_b2_sequence_gap']:+.12g}
- Wins vs Off: {incremental['real_vs_b2_off_sequences']['wins']}/256
- Wins vs Shuffled: {incremental['real_vs_b2_shuffled_sequences']['wins']}/256
...
"""
    ...
    make_2d2h_plots(
        output, milestones, training, incremental, attention, temporal, memory
    )
    durable_json(
        output / "FINAL_AUDIT.json",
        {"experiment": EXPERIMENT, "checks": integrity_checks, "passed": False},
    )
    inventory = build_artifact_inventory(output)
    final_audit = {
        "experiment": EXPERIMENT,
        ...
        "passed": scientific_integrity and inventory["passed"],
    }
    durable_json(output / "artifact_inventory.json", inventory)
    durable_json(output / "FINAL_AUDIT.json", final_audit)
    if not final_audit["passed"]:
        raise SystemExit(f"2D2H final audit failed: {final_audit}")
    print("EXPERIMENT_2D2H_FINALIZED_PENDING_SYNC_COMMIT_AND_STOP", flush=True)
    return summary
...
def add_execution_arguments(parser):
    ...
    parser.add_argument("--ephemeral-checkpoint-root", required=True)
    parser.add_argument(
        "--checkpoint-persist-lock",
        default="/workspace/parallel_2d2_master/locks/checkpoint_persist.lock",
    )
