...
if __name__=='__main__':
    p=argparse.ArgumentParser();p.add_argument('--archive',type=Path,required=True);p.add_argument('--bundle',type=Path,required=True);a=p.parse_args();launch(a.archive,a.bundle)
